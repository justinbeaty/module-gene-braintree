...
/**
 * Class Gene_Braintree_Block_Googlepay_Info
 *
 * @author Paul Canning <paul.canning@gene.co.uk>
 */
class Gene_Braintree_Block_Googlepay_Info extends Gene_Braintree_Block_Info
{
    /**
     * Class Construct
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('gene/braintree/googlepay/info.phtml');
    }
